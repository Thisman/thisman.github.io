...
Раскрасьте рёбра сетки четырьмя цветами так, чтобы у каждой вершины цвета различались. Сложности задают размер и число защищённых подсказок: Intro — 5×5/20, Easy — 6×6/29, Normal — 7×7/40, Hard — 8×8/52, Expert — 9×9/65, Extreme — 9×9/58. Каждый пазл имеет единственное решение; подсказки не образуют полностью открытых квадратов. Генерация отменяется новым кликом по табу и показывает лоадер минимум 2 секунды без сдвигов интерфейса. Цвет растекается от клика за 0,3 секунды и заполняет сектора вершин. Правый клик выбирает следующий цвет и красит ребро под указателем. Shift + ЛКМ стирает цвет доступного ребра независимо от выбранного цвета. Подсветка конфликтов, таймер, шесть палитр и сохранение текущей партии. Числовых уровней нет.
